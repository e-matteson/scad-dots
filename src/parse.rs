...
named!(
    cube<ScadThing>,
    ws!(do_parse!(
        tag!("cube") >> tag!("(") >> dims: triple >> tag!(")") >> tag!(";")
            >> (ScadThing::Cube(dims))
    ))
);
...
named!(
    sphere<ScadThing>,
    ws!(do_parse!(
        tag!("sphere") >> tag!("(d=") >> diameter: number >> tag!(")")
            >> tag!(";") >> (ScadThing::Sphere(diameter))
    ))
);
...
named!(
    cylinder<ScadThing>,
    ws!(do_parse!(
        tag!("cylinder") >> tag!("(") >> tag!("h=") >> height: number
            >> tag!(",") >> tag!("d=") >> diameter: number >> tag!(")")
